...
// Add new inventory item (vehicle) to the DB
async function newVehicleAdded( inv_make, inv_model, inv_description, inv_image, inv_thumbnail, inv_price, inv_year, inv_miles, inv_color, classification_id) {
  try {
...
module.exports = {getClassifications, getInventoryByClassificationId, getBuildByCarView, newClassification, checkExistingClassification, newVehicleAdded, updateInventory, deleteInventory}